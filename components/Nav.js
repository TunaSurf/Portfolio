  ...
  useEffect(() => {
    const distanceFromTop = () => {
      let scrollAmount =
        ...
        0;
      let scrollAmountExceedsThreshold = scrollAmount >= 50 ? true : false;

      if (scrolled != scrollAmountExceedsThreshold) {
        headerRef.current.classList.toggle("scrolled");
  ...
  return (
    <header ref={headerRef}>
      <div className="container">
        ...
        <nav>
          <Link href="/#projects">
            <a className={router.asPath == "/#projects" ? "active" : ""}>Projects</a>
          </Link>
          <Link href="/about">
